...
public class CreateQRCode {
    public static void main(String[] args) throws IOException {
        ...
        /*File file = new File("D:\\zlcd\\test\\1.jpg");
        ...
        //获取bufImg的中间位置
        int centerX = bufferedImage.getMinX() + bufferedImage.getWidth()/2 - width/2;
        int centerY = bufferedImage.getMinY() + bufferedImage.getHeight()/2 - height/2;
        g.drawImage(im,centerX,centerY,width,height,null);
        g.dispose();
        bufferedImage.flush();
        ...
        bufferedImage.flush();
        //设置图片格式，与输出的路径
        ImageIO.write(bufferedImage, "jpg", new File("D:\\zlcd\\test\\new3.jpg"));
